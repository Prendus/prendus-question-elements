...
export function secureEval(code: string): Promise<any> {
    return new Promise((resolve, reject) => {
        ...
        secureEvalIframe.setAttribute('src', 'node_modules/prendus-question-elements/services/secure-eval-iframe.html'); //TODO is it possible to do this inline? Then I could put the secure eval code in this file and make it even more portable, just a function. It will be possible with the srcdoc attribute, once Edge supports it
